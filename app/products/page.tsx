...
const products = [
  { id: 1, name: 'Ball', imageUrl: '/images/product/ball3.jpg', description: 'Description 1' },
  ...
  { id: 4, name: 'Scissor', imageUrl: '/images/product/scissor2.jpg', description: 'Description 4' },
